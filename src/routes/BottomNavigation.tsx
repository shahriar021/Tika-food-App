...
const icons = {
  ...
  homeInactive: require("../../assets/restroIcon/homeInactive.png"),
  cartActive: require("../../assets/restroIcon/cart-active.png"),
  cartInactive: require("../../assets/restroIcon/cart-inactive.png"),
  orderActive: require("../../assets/restroIcon/order-active.png"),
  orderInactive: require("../../assets/restroIcon/order-inactive.png"),
  profileActive: require("../../assets/restroIcon/profile-active.png"),
  profileInactive: require("../../assets/restroIcon/profile-inactive.png"),
};
        ...
        return {
          ...
          tabBarIcon: ({ focused }) => {
            ...
            if (route.name === "Home") {
              ...
              iconSource = focused ? icons.cartActive : icons.cartInactive;
            } else if (route.name === "My Orders") {
              iconSource = focused ? icons.orderActive : icons.orderInactive;
            } else if (route.name === "Profile") {
